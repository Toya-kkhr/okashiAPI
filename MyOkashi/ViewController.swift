...
//  MyOkashi
//
//  Created by 加古原　冬弥 on 2020/05/17.
...
class ViewController: UIViewController,UISearchBarDelegate,UITableViewDataSource,UITableViewDelegate,SFSafariViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        //search Barのデリゲート通知先を設定
        searchText.delegate = self
        
        //入力のヒントとなるブレースホルダーを設定
    ...
    //お菓子のリスト（タプル配列）
    var okashiList : [(name:String , maker:String , linl:URL , image:URL)] = []
    ...
    //SafariViewが閉じ込められる時に呼ばれるdelegateメソッド
